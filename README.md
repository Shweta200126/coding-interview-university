...
- ### Stack
    ...
    - [ ] Will implement stack questions on leetcode like valid parentheses
...
- ### Bitwise operations
    ...
    - [ ] Get a really good understanding of manipulating bits with: &, |, ^, ~, >>, <<
        ...
        - [X] [Python Programming Tutorial 5-9: Bitwise Operators (video)](https://www.youtube.com/playlist?list=PLBlnK6fEyqRjdKzSsGiBpr6fAxawT9WWb)
